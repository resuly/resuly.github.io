...
Firstly, I have tried the Matplotlib in Python. But the outcomes are good but they are static and not appropriate for the webpage. So I chose d3.js to draw the diagram from scratch. (The style with CSS and SVG tags drive me crazy, it is incompatible with this blog responsive CSS sheet. So I just give up display it on this page. Here is the gif version, simple and straightforward.)
